...
td_module_2 = \
    TDModuleWrapperRNN(
        ...
        mlp_modules=[td_module_2b, td_module_2c],
        mod_name='td_mod_2')
...
im_module_1 = \
    InfConvGRUModuleRNN(
        state_chans=(ngf * 3),
        td_state_chans=(ngf * 3),
        td_input_chans=(ngf * 3),
        bu_chans=(ngf * 3),
        rand_chans=nz1,
        spatial_shape=(7, 7),
        act_func='tanh',
