...
td_module_1a = \
    GenFCGRUModuleRNN(
        ...
        mod_name='td_mod_1a')
td_module_1b = \
    FCReshapeModuleRNN(  # FC -> (7, 7)
        in_shape=(ngf * 4,),
        out_shape=(ngf * 4, 7, 7),
        act_func=td_act_func,
        mod_name='td_mod_1b')
td_module_1c = \
    BasicConvModuleRNN(  # (7, 7) -> (14, 14)
        in_chans=(ngf * 4),
        out_chans=(ngf * 2),
        filt_shape=(5, 5),
        stride='half',
        ...
        mod_name='td_mod_1c')
td_module_1d = \
    BasicConvModuleRNN(  # (14, 14) -> (28, 28)
        in_chans=(ngf * 2),
        out_chans=(ngf * 1),
        filt_shape=(5, 5),
        stride='half',
...
td_module_1 = \
    TDModuleWrapperRNN(
        ...
        mlp_modules=[td_module_1b, td_module_1c, td_module_1d],
        mod_name='td_mod_1')
...
bu_module_1b = \
    BasicConvModuleRNN(
        ...
        stride='double',
        act_func=bu_act_func,
        mod_name='bu_mod_1b')  # (28, 28) -> (14, 14)
...
bu_module_2 = \
    BasicConvModuleRNN(
        ...
        stride='single',
        act_func=bu_act_func,
        mod_name='bu_mod_2')  # (28, 28) -> (28, 28)

# modules must be listed in "evaluation order"
bu_modules_gen = [bu_module_2, bu_module_1b, bu_module_1]
...
# modules must be listed in "evaluation order"
bu_modules_inf = [bu_module_2, bu_module_1b, bu_module_1]
...
im_module_2 = \
    InfConvGRUModuleRNN(
        state_chans=(ngf * 1),
        td_state_chans=(ngf * 1),
        td_input_chans=(ngf * 1),
        bu_chans=(ngf * 1),
        rand_chans=nz1,
        spatial_shape=(28, 28),
        act_func='tanh',
...
for i in range(10):
    ...
    xa_inf = T.concatenate([x_in, xg_gen], axis=1)
    res_dict = \
        seq_cond_gen_model.apply_im_uncond(
            input_inf=xa_inf,
            td_states=td_states,
