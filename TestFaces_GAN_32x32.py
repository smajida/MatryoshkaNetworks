...
desc = 'test_gan_paper_model_32x32'
...
# locations of 32x32 faces dataset -- stored as a collection of .npy files
...
data_files = [f for f in os.listdir(data_dir) if (f.find('32x32') > -1)]
data_files.sort()
