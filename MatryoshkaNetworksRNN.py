...
class DeepSeqCondGenRNN(object):
    ...
    def apply_bu_cond(self,
        ...
        # dicts for storing updated module states
        td_states_new = {}
        bu_states_new = bu_res_dict_gen['states']
        # now, run top-down pass which integrates bottom-up information
        td_outs = []
        for i, td_module in enumerate(self.td_modules):
            # get info about this TD module's connections
            td_mod_name = td_module.mod_name
            ...
            # construct some dummy latent variables to feed into TD module
            cond_z = 0. * td_input[:, :td_module.rand_chans, :, :]
