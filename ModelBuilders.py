...
def build_mnist_conv_res_gmm(nz0=32, nz1=4, ngf=32, ngfc=128, use_bn=False,
                             act_func='lrelu', use_td_cond=True, mix_comps=10,
                             depth_7x7=5, depth_14x14=5):
    #########################################
    # Setup the top-down processing modules #
    # -- these do generation                #
    ...
    # make the gaussian mixture prior module
